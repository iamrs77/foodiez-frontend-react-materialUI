...
function MenuForm(props) {
    ...
    let handleSubmit = (e) => {
        e.preventDefault();
        axios.post(`/api/v1/foodItem/add/${vendorId}`, {name, description, foodType, cost}, {headers: GetHeaders()}).then((response) => {
        ...
        <div className='form'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group col-12">
                    ...
                    <input type="text" className="form-control" id="description" placeholder="Enter Description" required onChange={(e) => {setDescrition(e.target.value)}}/>
                </div>
                ...
                <div className="form-group col-3">
                    ...
                    <input type="number" className="form-control" id="cost" placeholder="Enter Cost" required onChange={(e) => {setCost(e.target.value)}}/>
                </div>
